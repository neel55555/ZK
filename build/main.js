...
var ReportComponent = /** @class */ (function () {
    ...
    ReportComponent.prototype.onDateValueChange = function () {
        var _this = this;
        setTimeout(function () {
            _this._reportService.selectedDate = (_this.date.getMonth() + 1) + '-' + _this.date.getFullYear();
            _this._reportService.selectedDepartment = _this.department;
            _this._reportService.selectedUser = _this.user;
            _this._reportService.getReport().subscribe(function (data) { return _this.reports = data; });
        }, 300);
    };
